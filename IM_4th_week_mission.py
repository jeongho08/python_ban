...
c.pack()
c.create_oval(28,18, 150, 100, width=5, outline="purple", fill="pink")
c.create_line(0, 0, 250,200, width=9, fill="black")
c.create_rectangle(50, 150, 150, 300, width=4, outline="yellow", fill="orange" )
